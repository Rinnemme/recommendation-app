...
export default function Page() {
    ...
    return (
        <div className="mx-auto max-w-7xl py-10 px-6 lg:px-8 flex flex-col items-center">
            <div className="text-3xl mb-10 mt:4 sm:mt-6 sm:mb-12 text-slate-700 font-light">Movie Recommendations</div>
                ...
                {movies.map((movie) => {
                    return (
                        <li className="overflow-hidden bg-white px-6 py-6 shadow sm:rounded-md sm:px-6 relative">
                            <p className="text-xl font-semibold text-teal-600">{movie.name}</p>
