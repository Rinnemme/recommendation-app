        ...
        <div className="max-w-xl">
          <div className="text-center flex flex-col">
            <h1 className="text-5xl font-semibold leading-10 text-sky-950 sm:text-6xl mb-2">
              <span className="text-teal-600">Nerdy </span>
              <span className="text-sky-700">Recs</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Recommendations by nerds, for nerds. For now, we support
              recommendations for shows, movies, and video games. Feel free to
              browse around for some media consumption inspiration!
            </p>
