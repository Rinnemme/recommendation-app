...
export default function ShowForm({
  successFunc,
  failFunc,
}: Readonly<{ successFunc: () => void; failFunc: () => void }>) {
  ...
  const { register, handleSubmit, trigger, setValue, getValues, formState } =
  ...
  const togglePlatform = (platform: string) => {
    if (recPlatforms.includes(platform as never)) {
      ...
      setValue(
        "platform",
        recPlatforms.filter((p) => p !== platform).join(", ")
      );
      trigger("platform");
    } else {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      <div className="mt-3 text-center flex flex-col items-center sm:mt-5">
        <DialogTitle
          as="h3"
          className="text-3xl font-extralight leading-6 mb-10 mt-6 text-teal-600"
        >
          Recommend a show
        </DialogTitle>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.format?.message as ReactNode}
          </p>
        </div>

        <div className="w-72 mt-6">
          <label
            htmlFor="episodeLength"
            className="block font-medium leading-6 text-gray-900"
          >
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.episodeLength?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.episodeCount?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.releaseYear?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.ongoing?.message as ReactNode}
          </p>
        </div>
        ...
        {!isOngoing && (
          <div className="w-72 mt-6">
            ...
            <p className="mt-1 text-sm h-2 text-red-600">
              {errors.endYear?.message as ReactNode}
            </p>
          </div>
        )}
        ...
        <p className="mt-1 mb-2 text-sm h-2 text-red-600">
          {errors.platform?.message as ReactNode}
        </p>
        <Selector
          array={streamingPlatforms}
          state={recPlatforms}
          func={togglePlatform}
        />
        ...
        <p className="mt-1 mb-2 text-sm h-2 text-red-600">
          {errors.genre?.message as ReactNode}
        </p>
        ...
        <div className="w-11/12 sm:w-96 mt-6">
          ...
          <p className="mt-3 text-sm leading-6 text-gray-600">
            What's it about? What themes does it address? What does it make you
            feel? Give your pitch!
          </p>
          <p className="mt-1 text-sm h-2 text-red-600">
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.submittedBy?.message as ReactNode}
          </p>
        </div>
      </div>
