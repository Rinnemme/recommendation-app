...
export default function MovieForm({
  ...
  const { register, handleSubmit, trigger, setValue, formState } = useForm<any>(
    { mode: "onTouched" }
  );
    ...
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      <div className="mt-3 text-center flex flex-col items-center sm:mt-5">
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.starring?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.director?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-72 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.length?.message as ReactNode}
          </p>
        </div>
        ...
        <div className="w-11/12 sm:w-96 mt-6">
          ...
          <p className="mt-1 text-sm h-2 text-red-600">
            {errors.synopsis?.message as ReactNode}
          </p>
        </div>
